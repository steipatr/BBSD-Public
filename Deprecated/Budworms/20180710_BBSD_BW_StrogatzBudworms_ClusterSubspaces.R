...
saveloc <- paste(getwd(),"/Report/Final_Report/Figures/Budworms/Subspaces/",Sys.Date(),"-CID_PRIM.png",sep="")
...
saveloc <- paste(getwd(),"/Report/Final_Report/Figures/Budworms/Subspaces/",Sys.Date(),"-CID_PRIMinTrue.png",sep="")
