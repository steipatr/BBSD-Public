...
for (mthd in colnames(df_cl2)){
  ...
  loc <- paste(getwd(),"/Report/Report/Figures/Brusselator/ClusteringSolutions/2/Orig/",Sys.Date(),"-",mthd,"2-Orig.png",sep="")
...
for (mthd in colnames(df_cl2m)){
  ...
  loc <- paste(getwd(),"/Report/Report/Figures/Brusselator/ClusteringSolutions/2/Matched/",Sys.Date(),"-",mthd,"2-Matched.png",sep="")
  ggsave(plot = plt, loc, h = 4, w = 8, type = "cairo-png")
  print(paste(mthd,"done."))
}
