...
df_sils <- compare.silhouettes(df_red,cl_methods,2,8,logging=TRUE)
compare.silhouettes()
...
#export plot
saveloc <- paste(getwd(),"/Report/Report/Figures/ShaleGas/",Sys.Date(),"-OilpriceSilhouettes28.png",sep="")
