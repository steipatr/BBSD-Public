...
cl_methods <- c("CID","CORT","DWT","SBD","GAK")

df_sils <- compare.silhouettes(df_red,cl_methods,2,20,logging=TRUE)
...
#export plot
saveloc <- paste(getwd(),"/Report/Report/Figures/ShaleGas/",Sys.Date(),"-OilpriceSilhouettes2-20multi.png",sep="")
