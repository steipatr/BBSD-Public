...
cl_methods <- c("CID","CORT","DWT",rep("DTW",3),rep("SBD",3))

df_sils <- compare.silhouettes(df_red,cl_methods,kmin=2,kmax=50,kstep=2,logging=TRUE)
...
#export plot
saveloc <- paste(getwd(),"/Report/Final_Report/Figures/ShaleGas/",Sys.Date(),"-OilPriceSilhouettes2-50.png",sep="")
